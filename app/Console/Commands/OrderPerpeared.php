...
class OrderPerpeared extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'order:peppered';
     ...
     * @var string
     */
    protected $description = 'order:peppered';
        ...
        foreach ($orders as $order){
            ...
            if($status->save()){
                ...
                foreach ($users as $user) {
                    $this->sendMessage($user->device_token,__("general.order_accepted"),$user->id,3);
